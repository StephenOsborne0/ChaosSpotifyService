...
The project includes a PowerShell script to register and start the application as a Windows Service.
...
Once the service is running, it will create a file named `song.txt` in the build output directory (e.g., `ChaosSpotifyService\bin\Debug\net10.0-windows10.0.19041.0\song.txt`).
...
1. Open **PowerShell as Administrator**.
2. Run the unregistration script:
